Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   ...
                   DESC
  s.screenshots  = "https://raw.githubusercontent.com/itsmeichigo/ICGTransitionAnimation/master/Screenshot.png"
  ...
  s.source       = { :git => "https://github.com/itsmeichigo/ICGTransitionAnimation.git", :tag => "1.0" }
